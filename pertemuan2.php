<?php 
  include_once "init.php";
   ...
   $query_insert = "INSERT INTO mahasiswa (nama, nim, jenis_kelamin) VALUES('dian', 202265078, 'wanita')";
   $query_update = "UPDATE` mahasiswa SET nama='amelia', nim=202265000, jenis_kelamin='wanita' WHERE id=1";
